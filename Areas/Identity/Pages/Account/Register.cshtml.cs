...
namespace ShumenNews.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            [Required(ErrorMessage = "Моля въведете име")] //TODO Add more validations
            [Display(Name = "Име")]
            public string FirstName { get; set; }

            [Required(ErrorMessage = "Моля въведете фамилия")] //TODO Add more validations
            ...
            [StringLength(100, ErrorMessage = "Паролата трябва да е от {2} символа до най-много {1} символа голяма.", MinimumLength = 6)]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (_userManager.Users.Count() == 22)
                {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Потвърддете вашия имейл",
